...
Uninstallable=yes
OutputDir="C:\AddOn\ChessIT\ChessIT.Financeiro\Setup"
CloseApplications=force
OutputBaseFilename=setup
SourceDir="C:\AddOn\ChessIT\ChessIT.Financeiro\ChessIT.Financeiro\bin\x64\Release"

[Files]
Source: ChessIT.Financeiro.exe; Flags: ignoreversion; DestDir: {app}
Source: ChessIT.Financeiro.exe.config; Flags: ignoreversion; DestDir: {app}
...
[Registry]
Root: HKCU; Subkey: Software\ChessIT\ChessIT.Financeiro; Flags: uninsdeletekey
Root: HKLM; Subkey: Software\ChessIT\ChessIT.Financeiro; Flags: uninsdeletekey
Root: HKLM; Subkey: Software\ChessIT\ChessIT.Financeiro; ValueType: string; ValueName: InstallPath; ValueData: {app}
