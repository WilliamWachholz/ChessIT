    ...
    class BaixaCPView
    {
        ...
        private void Pesquisar()
        {
            string query = @"select '{14}' AS ""Check"",
                            ...
                            and ('{12}' = 'N' or '{14}' = 'Y' or ('{12}' = 'Y' and (PCH6.""InsTotal"" - PCH6.""PaidToDate"") = 0))
                            and ('{13}' = 'N' or '{14}' = 'Y' or ('{13}' = 'Y' and (PCH6.""InsTotal"" - PCH6.""PaidToDate"") > 0))
                            union
                            select  '{14}' AS ""Check"",
                            ...
                            and ('{12}' = 'N' or '{14}' = 'Y' or ('{12}' = 'Y' and (DPO6.""InsTotal"" - DPO6.""PaidToDate"") = 0))
                            and ('{13}' = 'N' or '{14}' = 'Y' or ('{13}' = 'Y' and (DPO6.""InsTotal"" - DPO6.""PaidToDate"") > 0))
                            union
                            select  '{14}' AS ""Check"",
